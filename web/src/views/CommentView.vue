...
export default {
    ...
    data() {
        return {
            ...
            defaultName: '蓝胖子',
            // 默认头像
            defaultePortrait: "http://124.71.44.221:8989/media/img/doraemon_logo.png",
            // 评论列表
            comments: [
                { name: "大雄", time: Date.now(), comment: "长风破浪会有时,直挂云帆济沧海", portrait: "http://124.71.44.221:8989/media/img/person/dx.png" },
            ],
            comment: null,
            // 用户输入
            strData: "",
    ...
    mounted() {
        ...
        axiosInstance.get('/queryAll?page=' + this.page,)
            .then(response => {
